...
def build_hint_graph():
    ...
    graph.add_edge("retrieve_rag", "generate_hint")
...
def predict():
    try:
        ...
        rag_context = graph_result["rag_context"]
        ...
        return jsonify(
            {
                ...
                "hint": hint,
                "rag_candidates": rag_results,
                "langgraph_note": "이 엔드포인트는 이미지 분석 없이 RAG와 Gemma 힌트 생성만 테스트합니다.",
            }
        )
...
if __name__ == "__main__":
    ...
    print("LangGraph Flow: analyze_image -> retrieve_rag -> generate_hint")
    print("Server Start")
